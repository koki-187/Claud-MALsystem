...
TERASS PICKS (https://picks-agent.terass.com/search/mansion) の物件データを自動的に Cloudflare D1 に同期する仕組みです。
...
1. Step 2 で起動した Chrome で https://picks-agent.terass.com/search/mansion が開く
2. 通常通りログイン
...
[extract-terass] TERASS PICKS タブ検出: https://picks-agent.terass.com/search/mansion...
...
**原因**: CDP モードの Chrome で `picks-agent.terass.com` (または旧 `picks.terass-agents.com`) が開いていない

**解決策**:
1. CDP 起動の Chrome (ポート 9222) で https://picks-agent.terass.com/search/mansion を開く
